...
export const UI_DICTIONARY: Record<string, Record<string, string>> = {
  en: {
    ...
    'about.team': 'The Team',
    'about.role': 'Senior Travel Designer',

    'services.sub': 'Exceptional care for your journey.',
    'services.how_work': 'How We Work',
    'services.step1_t': 'Consultation',
    'services.step1_d': 'We discuss your desires and requirements.',
    'services.step2_t': 'Curation',
    'services.step2_d': 'We design a bespoke itinerary.',
    'services.step3_t': 'Experience',
    'services.step3_d': 'You enjoy a seamless journey.',

    'blog.sub': 'Inspiring stories from around the globe.',
    'contact.sub': 'Let us craft your perfect itinerary.',
    'contact.hq_title': 'Global Headquarters',
    'contact.follow': 'Follow our journey',
    'contact.verified': 'Verified Client',
    ...
    'admin.manage_dest': 'Destinations',
    'admin.manage_blog': 'Blog Posts',
    'admin.settings': 'Settings',
    'admin.logout': 'Logout',
    'admin.welcome': 'Welcome Back',
    'admin.manage_dests_title': 'Manage Destinations',
    'admin.manage_blog_title': 'Manage Blog',
    'admin.site_config': 'Site Configuration',
    'admin.login_title': 'Admin Access',
    'admin.login_sub': 'Please login to continue',
    'admin.username': 'Username',
    'admin.password': 'Password',
    'admin.login_btn': 'Login',
    'admin.visitors': 'Total Visitors',
    'admin.bookings': 'Active Bookings',
    'admin.listed': 'Destinations Listed',
    ...
    'admin.add_dest': 'Add New Destination',
    'admin.edit_dest': 'Edit Destination',
    'admin.update': 'Update',
    'admin.create': 'Create',
    'admin.cancel': 'Cancel',
    'admin.name': 'Name',
  ...
  bg: {
    ...
    'about.team': 'Екипът',
    'about.role': 'Старши Дизайнер',

    'services.sub': 'Изключителна грижа за вашето пътуване.',
    'services.how_work': 'Как Работим',
    'services.step1_t': 'Консултация',
    'services.step1_d': 'Обсъждаме вашите желания и изисквания.',
    'services.step2_t': 'Планиране',
    'services.step2_d': 'Създаваме персонализиран маршрут.',
    'services.step3_t': 'Преживяване',
    'services.step3_d': 'Вие се наслаждавате на безпроблемно пътуване.',

    'blog.sub': 'Вдъхновяващи истории от целия свят.',
    'contact.sub': 'Нека създадем вашия перфектен маршрут.',
    'contact.hq_title': 'Централен Офис',
    'contact.follow': 'Последвайте ни',
    'contact.verified': 'Потвърден Клиент',
    ...
    'contact.terms': 'Съгласен съм с Общите условия на сайта',
    'contact.captcha': 'Въпрос за сигурност',
    'contact.captcha_q': 'Колко е {a} + {b}?',
    'contact.answer': 'Отговор',
    ...
    'cookie.title': 'Ние ценим вашата поверителност',
    ...
    'admin.manage_dest': 'Дестинации',
    'admin.manage_blog': 'Блог',
    'admin.settings': 'Настройки',
    'admin.logout': 'Изход',
    'admin.welcome': 'Добре дошли отново',
    'admin.manage_dests_title': 'Управление на Дестинации',
    'admin.manage_blog_title': 'Управление на Блог',
    'admin.site_config': 'Конфигурация на Сайта',
    'admin.login_title': 'Админ Вход',
    'admin.login_sub': 'Моля влезте в системата',
    'admin.username': 'Потребител',
    'admin.password': 'Парола',
    'admin.login_btn': 'Вход',
    'admin.visitors': 'Посетители',
    'admin.bookings': 'Резервации',
    'admin.listed': 'Активни Дестинации',
    'admin.add_post': '+ Добави Пост',
    'admin.status': 'Статус',
    'admin.title': 'Заглавие',
    'admin.date': 'Дата',
    'admin.actions': 'Действия',
    'admin.draft': 'Чернова',
    'admin.published': 'Публикуван',
    'admin.add_dest': 'Добави Нова Дестинация',
    'admin.edit_dest': 'Редактирай Дестинация',
    'admin.update': 'Обнови',
    'admin.create': 'Създай',
    'admin.cancel': 'Отказ',
    'admin.name': 'Име',
    ...
    'admin.price': 'Цена',
    'admin.type': 'Тип',
    'admin.image_url': 'URL на Снимка',
    'admin.desc': 'Описание',
    'admin.ai_gen': 'AI Генериране',
    'admin.menu': 'Меню',
  }
};